// Sidebar.jsx (perbaikan minimal)
import { useNavigate } from "react-router-dom";
import {
  FaBars, FaBox, FaSignInAlt, FaSignOutAlt,
  FaClipboardList, FaDatabase, FaExchangeAlt,
  FaBoxes, FaChartPie
} from "react-icons/fa";
...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <>
      {/* Tombol Toggle Mobile (pastikan di atas Navbar) */}
      <button
      ...
      >
        <div className="p-4 text-lg font-bold border-b flex items-center gap-2">
          <img
            src="/ChatGPT_Image_8_Agu_2025__23.59.29-removebg-preview (1).png"
            alt="Logo"
