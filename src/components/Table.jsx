...
export default function Table({ headers, children }) {
  ...
  return (
    <div className="w-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-transparent border-b-2 border-gray-300 focus:border-blue-500 outline-none px-1 py-1 pr-6 text-gray-800 font-medium transition-all duration-200"
            >
          ...
          <thead>
            <tr className="bg-blue-500">
              {headers.map((header, idx) => (
                <th
                  key={idx}
                  className="p-3 text-left cursor-pointer select-none text-white whitespace-nowrap"
      ...
      {/* Bottom Controls */}
      <div className="flex flex-col md:flex-row justify-between items-center mt-3 text-sm text-gray-600">
        <span>
